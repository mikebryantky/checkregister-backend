...
(
    ...
    constraint category_description_uindex
        unique (description),
    constraint category_transaction_type_uuid_fk
        foreign key (transaction_type_uuid) references transaction_type (uuid)
);

INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('12c91278-92b0-48db-8168-9134a7c8caa6', 'Auto', '32b1e209-ee18-4340-b00c-b6fa64a80e33');
INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('2d5a62d2-6782-46bc-831a-bf11dd0a5858', 'Misc Expense', '32b1e209-ee18-4340-b00c-b6fa64a80e33');
INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('61dfa74a-cb41-4971-98da-f9d39946f9e5', 'Credit Card', '32b1e209-ee18-4340-b00c-b6fa64a80e33');
INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('7c19a7c4-86a7-4e09-9d0f-bd3e2fcda7cd', 'Misc Income', '8c8fa709-d826-4613-9fbd-2d9fd6554c1b');
INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('97902475-1f0b-4efe-aed0-e061795f5304', 'Payroll', '8c8fa709-d826-4613-9fbd-2d9fd6554c1b');
INSERT INTO transaction_category (uuid, description, transaction_type_uuid)
    VALUES ('c252c5f6-d6af-4fdb-859d-391b5bc771dd', 'Utilities', '32b1e209-ee18-4340-b00c-b6fa64a80e33');
...
(
    ...
    deposit_amount            float(7, 2)  null,
    withdrawal_amount         float(7, 2)  null,
...
create index category_transaction_type_index
    on transaction_category (transaction_type_uuid);
